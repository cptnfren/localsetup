...
- **Repository policy docs:** Maintainers should not add `Co-authored-by` trailers for AI tools or list tools in contributor/credit sections.
...
See this document and `docs/MAINTENANCE_WORKFLOW.md` for maintainer policy context.

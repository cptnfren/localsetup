...
Use your platform's command or terminal to run the patch scripts. Paths are relative to the skill directory (e.g. `_localsetup/skills/localsetup-linux-patcher/` or `framework/skills/localsetup-linux-patcher/`); adjust for your layout.

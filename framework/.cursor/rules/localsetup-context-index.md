...
| localsetup-automatic-versioning | Automatic semantic versioning from conventional commits; VERSION, hook, sync to READMEs/docs | Version bumps, release workflow, conventional commits, versioning docs |

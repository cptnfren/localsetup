...
|-------|-------------|--------------|
| localsetup-context.md | Master rule: overview, invariants, skills index, docs index | Always |
...
| localsetup-skill-sandbox-tester | Test skills in isolated sandbox; smoke check; on failure use debug-pro; no repo writes until approved | Validate skill after import, test skill in sandbox, ensure skill runs before production |

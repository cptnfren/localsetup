...
Use your platform's command or terminal to run the patch scripts. Paths are relative to the skill directory (e.g. `_localsetup/skills/localsetup-linux-patcher/` or `_localsetup/skills/localsetup-linux-patcher/`); adjust for your layout.
...
- **Scheduling:** Use your platform's scheduler or system cron. Example (Linux cron): `0 2 * * * cd /path/to/localsetup-linux-patcher && scripts/patch-auto.sh`.

...
| Deploy | `./_localsetup/tools/deploy` | `.\_localsetup\_localsetup\tools\deploy.ps1` |
| Verify context | `./_localsetup/tools/verify_context` | `.\_localsetup\_localsetup\tools\verify_context.ps1` |
| Verify rules | `./_localsetup/tools/verify_rules` | `.\_localsetup\_localsetup\tools\verify_rules.ps1` |
| Tests | `./_localsetup/tests/automated_test.sh` | `.\_localsetup\_localsetup\tests\automated_test.ps1` |
